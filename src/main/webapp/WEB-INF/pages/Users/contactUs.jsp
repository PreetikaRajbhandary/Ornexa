...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/css/c.css" />
</head>
<body>
    ...
    <jsp:include page="Header.jsp" />
        ...
        <div class="contact-main">
            ...
            <div class="form-container">
                <form action="ContactUsServlet" method="post" id="contactForm">
				...
				<div id="popup" class="popup">
				  <div class="popup-content">
				    <h2>Message Sent!</h2>
				    <p>Thank you for contacting Ornexa. We’ll get back to you soon.</p>
				    <a href="<%=request.getContextPath()%>/ContactUsServlet" class="close-btn">Close</a>	
				   </div>
				</div>
