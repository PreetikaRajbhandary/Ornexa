...
<div class="body1">
        <div class="container1">
            <div class="left_image">
							...
							<img class="main_image" src="${pageContext.request.contextPath}/picture/main diamond ring.png">  
							<div class="small_images">
                            <img src="${pageContext.request.contextPath}/picture/women-daimond ring.png">
							<img src="${pageContext.request.contextPath}/picture/men-diamondring.png">
							<img src="${pageContext.request.contextPath}/picture/diamondring.png"
            ...
            <div class="more_collection">
                 ...
                 <!-- MAIN SLIDES -->
                <div class="list active" data-index="0">
                    <div class="imagee">
                        <img src="picture/newari_rings.png">

                        <div class="content">
                            <div class="jewlery_name">ornexa</div>
                            <div class="title">More Collections</div>
                            <div class="topic">Pyakhan Ring </div>
                            <div class="about_jewlery">Heritage in every detail.</div>
                ...
                <div class="list">
                    <div class="imagee" data-index="1">
                        <img src="picture/mennn.png">
                        <div class="content">
                            <div class="jewlery_name">ornexa</div>
                            <div class="title">More Collections</div>
                            <div class="topic">Spine-Link Bracelet</div>
                            <div class="about_jewlery">Bold Geometry. Timeless Power.</div>
                ...
                <div class="list">
                    <div class="imagee" data-index="2">
                        <img src="picture/women braclets.png">
                        <div class="content">
                            <div class="jewlery_name">ornexa</div>
                            <div class="title">More Collections</div>
                            <div class="topic">Vine Braclets</div>
                            <div class="about_jewlery">Nature-inspired elegance in radiant rose gold.</div>
                ...
                <div class="list">
                    <div class="imagee" data-index="3">
                        <img src="picture/earring_cuff.png">
                        <div class="content">
                            <div class="jewlery_name">ornexa</div>
                            <div class="title">More Collections</div>
                            <div class="topic">Emerald-Rain Jhumkas</div>
                            <div class="about_jewlery">perfect for weddings</div>
                ...
                <div class="list">
                    <div class="imagee" data-index="4">
                        <img src="picture/necklacee.png">
                        <div class="content">
                            <div class="jewlery_name">ornexa</div>
                            <div class="title">More Collections</div>
                            <div class="topic">Lotus Meenakari Necklace</div>
                            <div class="about_jewlery">Pure elegance in every petal.</div>
...
<!-- JS -->
<script>const slider = document.querySelector('.inner_slider');
